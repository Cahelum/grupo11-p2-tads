		...
		if (myList[0] == null) {
			...
			while (cambio == true) {
				...
				if (myList[2 * i + 1] != null && myList[2 * i + 2] != null) {
					...
					if (myList[2 * i + 1].getKey().compareTo(myList[2 * i + 2].getKey()) == 1) {

						if (myList[2 * i + 1].getKey().compareTo(myList[(((2 * i + 2) - 1) / 2)].getKey()) == 1) {
						...
						if (myList[2 * i + 2].getKey().compareTo(myList[(((2 * i + 2) - 1) / 2)].getKey()) == 1) {
					...
					if (myList[2 * i + 1] != null && myList[i].getKey().compareTo(myList[2 * i + 2].getKey()) == 1) {
